...
import 'package:facility/pages/reset_password.dart';
import 'package:facility/pages/signup_screen.dart';
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                logoWidget("lib/images/google.png"),
                const SizedBox(
                  height: 30,
                ),
